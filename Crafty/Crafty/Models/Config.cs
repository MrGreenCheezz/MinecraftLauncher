namespace Crafty.Models
{
	public class Config
	{
		...
		public string UserJavaPath { get; set; }

		public Config(string? username, int ram, string? lastVersionUsed, bool getSnapshots, bool getBetas, bool getAlphas, string JavaPath)
		{
			Username = username;
			Ram = ram;
